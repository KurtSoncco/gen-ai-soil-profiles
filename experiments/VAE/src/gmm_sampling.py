...
def extract_latent_samples(model, data_loader, device, max_samples: Optional[int] = None):
...
def vs_to_log_vs_profiles(vs_profiles: np.ndarray, depths: np.ndarray, vs_min: float = 50.0) -> np.ndarray:
