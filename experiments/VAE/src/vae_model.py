...
def vae_loss_function(reconstruction, x, mu, log_var, beta: float = 1.0):
    """
    Standard VAE loss with configurable beta and mean reduction for stability.
    """
    recon = nn.functional.mse_loss(reconstruction, x, reduction="mean")
